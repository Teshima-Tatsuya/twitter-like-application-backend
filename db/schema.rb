...
ActiveRecord::Schema[7.1].define(version: 2024_07_16_011056) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.index ["following_user_id", "follower_user_id"], name: "index_follows_on_following_user_id_and_follower_user_id", unique: true
